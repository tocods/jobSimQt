...
class UI:
    def setup_ui(self, main_win: QMainWindow) -> None:
        ...
        self.action_out = QAction(QIcon("img/退出.png"), "退出")
        ...
        menu_out = menubar.addMenu("退出")
        menu_out.addActions((self.action_open_folder, self.action_open_color_dialog, self.action_open_font_dialog))
        ...
        tool_btn_settings.setMenu(menu_out)
