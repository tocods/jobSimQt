...
class JobSimQt(QMainWindow):
    ...
    def _run(self):
        ...
        if sysSim.jobs == {}:
            ...
            self._ui.central_window.centralWidget().setEnabled(True)
            return
        execute = "./jdk1.8.0_321/bin/java -jar ./jobSim/gpuworkflowsim.jar " + project.projectPath + "/OutputFiles " + project.projectPath + "/hosts.json " + project.projectPath + "/jobs.json " + project.projectPath + "/faults.json " + str(0) + " " + str(self.duration)
        print(execute)
