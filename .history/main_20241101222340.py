...
class JobSimQt(QMainWindow):
    ...
    def _initJobResult(self):
        ...
        self._ui.resultui.jobshow1.setStyleSheet("color:skyblue")
        self._ui.resultui.jobshow1.setFont(font)
        ...
        otherFormat = '<font color="orange" size="50">{}</font>'
        numFormat = '<font color="skyblue" size="50">{}</font>'
        # Append different texts
        self._ui.resultui.jobshow2.append(errorFormat.format('This is error text')) #该内容显示为红色
        self._ui.resultui.jobshow2.append(warningFormat.format('This is warning text')) #该内容显示为橙色
        self._ui.resultui.jobshow2.append(validFormat.format('This is a valid text'))   #该内容显示为绿色
