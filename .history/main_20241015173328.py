...
class JobSimQt(QMainWindow):
    ...
    def initTreeView(self):
        ...
        self.setGeometry(0, 0, screen_size.width() * 0.4, screen_size.height() * 0.4)
        self._ui.homeui.widget.setGeometry(0, 0, screen_size.width() * 0.3, screen_size.height() * 0.3)
    ...
    def _run(self):
        self._ui.central_window.centralWidget().setEnabled(fa)
        self._ui.action_enable.setEnabled(state == "Disable")
        self._ui.action_disable.setEnabled(state == "Enable")
