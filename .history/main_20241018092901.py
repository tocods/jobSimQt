...
class JobSimQt(QMainWindow):
    ...
    def _initResult(self):
        ...
        self._ui.resultui.showCPU.setChart(chart)
        chartCPU = self.painter.plotHostCPUUtilization("udp_cpu", -1, float("inf"))
        self._ui.resultui.showCPUUtilization.setChart(chartCPU)
        chartGPU = self.painter.plotHostGPUUtilization("udp_cpu", -1, float("inf"))
