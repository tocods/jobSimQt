...
class JobSimQt(QMainWindow):
    ...
    def _initKernelTable(self, kernel_num, gpu_task):
        self.jobInfoPage.gputable.setColumnCount(7)
        ...
        i = 0
        for kernel_info in gpu_task.kernel_infos:
            i += 1
            ...
            self.jobInfoPage.gputable.setItem(i, 3, QTableWidgetItem(str(kernel_info.flop_per_thread)))
            self.jobInfoPage.gputable.setItem(i, 4, QTableWidgetItem(str(kernel_info.need_gddram)))
            self.jobInfoPage.gputable.setItem(i, 5, QTableWidgetItem(str(kernel_info.input_data_size)))
            self.jobInfoPage.gputable.setItem(i, 6, QTableWidgetItem(str(kernel_info.output_data_size)))
