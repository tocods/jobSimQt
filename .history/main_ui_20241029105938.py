...
class UI:
    def setup_ui(self, main_win: QMainWindow) -> None:
        # Actions
        self.action_change_home = QAction(QIcon("img/网络仿真结果分析.png"), "运行仿真")
        self.action_change_dock = QAction(QIcon("img/系统管理结果分析.png"), "查看结果")
        ...
        toolbar.addActions((self.action_open_folder))
        ...
        menu_toggle = menubar.addMenu("数据分析软件")
