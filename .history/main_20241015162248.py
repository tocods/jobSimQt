...
class JobSimQt(QMainWindow):
    ...
    def initTreeView(self):
        item = QTreeWidgetItem(["主机"])
        item.setIcon(0, QIcon("img/主机记录.png"))
        QIcon icon;
icon.addPixmap(QPixmap(":/img/tree/object_sel.png"), QIcon::Selected);
icon.addPixmap(QPixmap(":/img/tree/object.png"), QIcon::Normal);
————————————————

                            版权声明：本文为博主原创文章，遵循 CC 4.0 BY-SA 版权协议，转载请附上原文出处链接和本声明。
                        
原文链接：https://blog.csdn.net/hellokandy/article/details/115546048
        self._ui.homeui.infoList.insertTopLevelItem(0, item)
