...
class JobSimQt(QMainWindow):
    ...
    def _applyHost(self):
        ...
        self.nowHost.cpu_infos = [CPUInfo(cpucore // cpunum, cpuflops)]
        self.nowHost.cpu_infos = [CPUInfo(cpucore // cpunum, cpuflops)]
        self.nowHost.cpu_infos = [CPUInfo(cpucore // cpunum, cpuflops)]
        self.nowHost.cpu_infos = [CPUInfo(cpucore // cpunum, cpuflops)]
        self.nowHost.cpu_infos = [CPUInfo(cpucore // cpunum, cpuflops)]
        ...
        self.nowHost.cpu_infos = [CPUInfo(cpucore // cpunum, cpuflops)]
        self.nowHost.cpu_infos = [CPUInfo(cpucore // cpunum, cpuflops)]
        self.hostInfoPage.hostName.setText(self.nowHost.name)
        self.hostInfoPage.ram.setValue(self.nowHost.ram)
        self.hostInfoPage.corenum.setValue(cpucore)
        self.hostInfoPage.cpunum.setValue(cpunum)
        self.hostInfoPage.cpuflops.setText(cpuflops)
