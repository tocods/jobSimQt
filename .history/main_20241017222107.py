...
class JobSimQt(QMainWindow):
    ...
    def _initFaultInfo(self, fault: FaultGenerator, ifTrueFault=True):
        ...
        self._getNormalLine(fault.mttf_scale)


    def _getNormalLine(self, avg):
        ...
        self.series.setName("Normal Distribution")
        # 填充QLineSeries
...
原文链接：https://blog.csdn.net/qq_45957458/article/details/128425208
