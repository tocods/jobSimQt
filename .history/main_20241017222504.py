...
class JobSimQt(QMainWindow):
    ...
    def _getNormalLine(self, avg, avg2):
        ...
        data = rng.normal(avg, 1, 1000) 
        res_freq = stats.relfreq(data, numbins=10)
        ...
        self.faultInfoPage.chat.addSeries(self.series)
        # 设置x坐标
        ...
        self.faultInfoPage.chat.addAxis(self.axis_x,Qt.AlignBottom) # 在表格中加入坐标，位置为底部
        self.series.attachAxis(self.axis_x) # 自动让QLineSeries贴附

        # 设置y坐标
        self.axis_y=QValueAxis()
        self.axis_y.setTickCount(100)
        self.axis_y.setLabelFormat("%.2f")
        self.axis_y.setTitleText("概率")
        self.faultInfoPage.chat.addAxis(self.axis_y,Qt.AlignLeft)
