...
class JobSimQt(QMainWindow):
    ...
    def _run(self):
        ...
        if jobs == []:
            ...
            return
        execute = "java -jar ./jobSim/gpuworkflowsim.jar " + projectPath + "/OutputFiles " + projectPath + "/jobSim/input/hosts.json " + projectPath + "/jobSim/input/jobs.json " + projectPath + "/jobSim/input/faults.json " + str(0) + " " + str(sysSim.duration)
        print(execute)
