...
class JobSimQt(QMainWindow):
    ...
    def _initJobResult(self):
        ...
        otherFormat = '<font color="white" size="3">{}</font>'
        ...
        # 字体大，天蓝色
        self._ui.resultui.jobshow1.append(numFormat.format(str(self.throughput))) 
        self._ui.resultui.jobshow1.append(otherFormat.format('FLOPS/s')) 
