    ...
    def _initResult(self):
        ...
        for job in self.job_results:
            ...
            for jobRun in job.jobRuns:
                percent += jobRun.duration / duration
        ...
        self.jobSeries.setPieStartAngle(startAngle)
        self.jobSeries.setPieEndAngle(endAngle)
        ...
        chart.setTitle("任务平均利用率:" + str(percent_total * 100) + "%")
