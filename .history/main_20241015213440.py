...
class JobSimQt(QMainWindow):
    ...
    def __initJobInfo(self, job):
        ...
        self.jobInfoPage.corenum.setValue(job.corenum)
        self.jobInfoPage.cpuflops.setText(str(job.cpuflops))
        self.jobInfoPage.gputable.setModel(GPUInfo(job.gpus).model)
        self.jobInfoPage.gputable.resizeColumnsToContents()
        self.jobInfoPage.gputable.resizeRowsToContents()
