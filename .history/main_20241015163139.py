...
class JobSimQt(QMainWindow):
    ...
    def _showInfo(self):
        ...
        root = self._ui.homeui.infoList.currentItem().parent()
        if root is None:
            root = self._ui.homeui.infoList.currentItem()
        self.nowClect = root.text(0)
        print(self.nowClect)
    ...
    def _add(self):
        ...
        self._ui.homeui.infoList.currentItem().addChild(item)
