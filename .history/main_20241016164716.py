    ...
    def _applyHost(self):
        ...
        if self.gpu_num > 0:
            ...
            for i in range(self.hostInfoPage.gputable.rowCount() - 1):
                gpu = GPUInfo(int(self.hostInfoPage.gputable.item(i + 1, 1).text()), (int)(self.hostInfoPage.gputable.item(i + 1, 2).text()), (int)(self.hostInfoPage.gputable.item(i+ 1, 3).text()), (int)(self.hostInfoPage.gputable.item(i, 4).text()), (int)(self.hostInfoPage.gputable.item(i, 5).text()))
                gpus.append(gpu)
