...
class JobSimQt(QMainWindow):
    ...
    def _initHostInfo(self, host: HostInfo):
        ...
        cpucore = cpunum * host.cpu_infos[0].corenum
        for cpuinfo in host.cpu_infos:
            self.hostInfoPage.cpuflops.setText(cpuinfo.flops)
        self.hostInfoPage.corenum.setValue(host.cpu_infos)
