...
import PySide6.QtWidgets import QTableWidget, QTableWidgetItem
...
class JobSimQt(QMainWindow):
    ...
    def _initResult(self):
        ...
        for hostRecord in self.cluster_result.hostRecords:
            ...
            self.hostTable.setItem(row, 0, QtWidgets.QTableWidgetItem(hostRecord.hostName))
            ...
            self.hostTable.setCellWidget(row, 4, seeMore)
