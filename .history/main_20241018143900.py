...
class JobSimQt(QMainWindow):
    ...
    def _run(self):
        ...
        if sysSim.jobs == {}:
            ...
            self._ui.central_window.centralWidget().setEnabled(True)
            return
        execute = "java -jar ./jobSim/gpuworkflowsim.jar " + project.projectPath + "/OutputFiles " + project.projectPath + "/hosts.json " + project.projectPath + "/jobs.json " + projectPath + "/faults.json " + str(0) + " " + str(100)
        print(execute)
