...
class JobSimQt(QMainWindow):
    ...
    def _run(self):
        ...
        if sysSim.jobs == {}:
            ...
            return
        execute = "java -jar ./jobSim/gpuworkflowsim.jar " + projectPath + "/OutputFiles " + projectPath + "/hosts.json " + projectPath + "/jobs.json " + projectPath + "/jobSim/input/faults.json " + str(0) + " " + str(100)
        print(execute)
