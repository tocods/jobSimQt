    ...
    def _applyHost(self):
        ...
        if self.gpu_num > 0:
            ...
            for i in range(self.hostInfoPage.gputable.rowCount() - 1):
                gpu = GPUInfo(self.hostInfoPage.gputable.item(i, 1).text().in, self.hostInfoPage.gputable.item(i, 2).text(), self.hostInfoPage.gputable.item(i, 3).text(), self.hostInfoPage.gputable.item(i, 4).text(), self.hostInfoPage.gputable.item(i, 5).text())
                gpus.append(gpu)
