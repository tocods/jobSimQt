        ...
        if self.nowClect.text(0) == '主机':
            ...
            for job in self.jobs:
                if job.name == self._ui.homeui.infoList.currentItem().text(0):
                    ...
                    self.jobInfoPage.jobType.setText(job.type)
                    self.jobInfoPage.jobPriority.setText(str(job.priority))
                    self.jobInfoPage.jobTime.setText(str(job.time))
                    self.jobInfoPage.jobSize.setText(str(job.size))
                    self.jobInfoPage.jobHost.setText(job.host)
                    self.jobInfoPage.jobStatus.setText(job.status)
                    self.jobInfoPage.jobFault.setText(job.fault)
                    self.jobInfoPage.jobFaultTime.setText(str(job.faultTime))
                    self.jobInfoPage.jobFaultReason.setText(job.faultReason)
