...
from util.jobSim import sysSim, ParseUtil, HostInfo, CPUInfo, GPUInfo, VideoCardInfo, JobInfo, CPUTaskInfo, GPUTaskInfo, FaultGenerator, tranFromC2E
...
class JobSimQt(QMainWindow):
    ...
    def _initFaultInfo(self, fault: FaultGenerator, ifTrueFault=True):
        ...
        self.faultInfoPage.type.setCurrentText(fault.type)
        self.faultInfoPage.time1.setText(str(fault.time1))
        self.faultInfoPage.time2.setText(str(fault.time2))
    ...
    def _delete(self):
        ...
        if self.nowClect.text(0) == '主机':
            ...
            self._initFaultInfo(FaultGenerator("z", 0, 0), False)
