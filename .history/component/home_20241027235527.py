...
class Ui_home(object):
    def setupUi(self, home):
        ...
        home.resize(809, 640)
        self.layoutWidget = QtWidgets.QWidget(parent=home)
        self.layoutWidget.setGeometry(QtCore.QRect(140, 50, 528, 271))
        ...
        self.add = QtWidgets.QPushButton(parent=self.layoutWidget)
        ...
        self.infoList = QtWidgets.QTreeWidget(parent=self.layoutWidget)
        self.infoList.setColumnCount(0)
        self.infoList.setObjectName("infoList")
        self.verticalLayout.addWidget(self.infoList)
        self.run = QtWidgets.QPushButton(parent=self.layoutWidget)
        icon2 = QtGui.QIcon()
