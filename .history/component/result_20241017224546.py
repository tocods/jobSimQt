...
class Ui_Resu(object):
    def setupUi(self, Form):
        ...
        self.jobResultAnalysis = QtWidgets.QWidget(parent=self.layoutWidget)
        ...
        self.showCPU = QtWidgets.QWidget(parent=self.layoutWidget)
        self.showCPU.setObjectName("showCPU")
        self.horizontalLayout.addWidget(self.showCPU)
        self.showCPU_2 = QtWidgets.QWidget(parent=self.layoutWidget)
        self.showCPU_2.setObjectName("showCPU_2")
        self.horizontalLayout.addWidget(self.showCPU_2)
        self.horizontalLayout.setStretch(0, 1)
        self.horizontalLayout.setStretch(1, 1)
        self.verticalLayout_3.addLayout(self.horizontalLayout)
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.showGPU = QtWidgets.QWidget(parent=self.layoutWidget)
        self.showGPU.setObjectName("showGPU")
        self.horizontalLayout_2.addWidget(self.showGPU)
        self.show = QtWidgets.QWidget(parent=self.layoutWidget)
        ...
        self.faultResultAnalysis = QtWidgets.QWidget(parent=self.layoutWidget)
