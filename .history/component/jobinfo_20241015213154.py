...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(140, 90, 501, 491))
...
"border-radius: 15px; ")
        ...
        self.gputable = QtWidgets.QTableView(parent=self.layoutWidget)
...
"")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_7.setText(_translate("Form", "CPU部分信息"))
        self.label_9.setText(_translate("Form", "需求核数:"))
        self.label_10.setText(_translate("Form", "FLOP:"))
        self.label_11.setText(_translate("Form", "GPU部分信息"))
