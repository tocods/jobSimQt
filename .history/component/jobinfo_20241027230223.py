...
class Ui_JobInfo(object):
    def setupUi(self, Form):
        ...
        Form.resize(1184, 699)
        self.widget = QtWidgets.QWidget(parent=Form)
        self.widget.setGeometry(QtCore.QRect(20, 20, 971, 541))
...
"border-radius: 15px; ")
        ...
        self.ram = QtWidgets.QLineEdit(parent=self.layoutWidget_2)
...
"")
        ...
        self.showjob = QChartView(parent=self.widget)
        self.showjob.setObjectName("widget_3")
    ...
    def retranslateUi(self, Form):
        ...
        self.label_8.setText(_translate("Form", "任务运行"))
