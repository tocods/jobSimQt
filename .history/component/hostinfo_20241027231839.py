# Form implementation generated from reading ui file 'hostinfo.ui'
#
...
class Ui_HostInfo(object):
    def setupUi(self, Form):
        ...
        Form.resize(1215, 671)
        Form.setStyleSheet("")
        self.widget = QtWidgets.QWidget(parent=Form)
        self.widget.setGeometry(QtCore.QRect(20, 20, 1021, 531))
...
"border-radius: 15px; ")
        ...
        self.layoutWidget.setGeometry(QtCore.QRect(0, 0, 201, 161))
        ...
        self.hostName = QtWidgets.QLineEdit(parent=self.layoutWidget)
        self.hostName.setStyleSheet("border: none")
        ...
        self.ram = QtWidgets.QSpinBox(parent=self.layoutWidget)
        ...
        self.pcie = QtWidgets.QDoubleSpinBox(parent=self.layoutWidget)
        self.pcie.setStyleSheet("border: none")
...
"border-radius: 15px; ")
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 10, 201, 191))
...
"")
        ...
        self.cpunum = QtWidgets.QSpinBox(parent=self.layoutWidget1)
        self.cpunum.setStyleSheet("border:none")
        self.cpunum.setObjectName("cpunum")
        ...
        self.corenum = QtWidgets.QSpinBox(parent=self.layoutWidget1)
        ...
        self.cpuflops = QtWidgets.QLineEdit(parent=self.layoutWidget1)
        ...
        self.gputable = QtWidgets.QTableWidget(parent=self.widget)
...
"")
        ...
        self.cpushow = QChartView(parent=self.widget)
        self.cpushow.setObjectName("cpushow")
        self.verticalLayout_8.addWidget(self.cpushow)
        self.ramshow = QChartView(parent=self.widget)
        self.ramshow.setObjectName("ramshow")
        self.verticalLayout_8.addWidget(self.ramshow)
        self.gpushow = QChartView(parent=self.widget)
        self.gpushow.setObjectName("gpushow")
        self.verticalLayout_8.addWidget(self.gpushow)
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "主机名:"))
        self.label_2.setText(_translate("Form", "内存:"))
        self.label_3.setText(_translate("Form", "GB"))
        self.label_4.setText(_translate("Form", "PCIe带宽:"))
        self.label_5.setText(_translate("Form", "GB/s"))
        self.label_7.setText(_translate("Form", "CPU信息"))
        self.label_8.setText(_translate("Form", "CPU数:"))
        self.label_9.setText(_translate("Form", "CPU核数:"))
        self.label_10.setText(_translate("Form", "核FLOPS:"))
        self.label_11.setText(_translate("Form", "GPU信息"))
