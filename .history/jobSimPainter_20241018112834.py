...
class XmlParser:
    ...
    def parseReliabilityRecord(self):
        reliabilityRecordList = []
        for reliabilityRecordElement in self.root.findall('reliabilityRecord'):
            reliabilityRecord = ReliabilityRecord(reliabilityRecordElement.attrib['time'], reliabilityRecordElement.attrib['object'], reliabilityRecordElement.attrib['isFalseAlarm'],
                                      reliabilityRecordElement.attrib['type'], reliabilityRecordElement.attrib['isSuccessRebuild'], reliabilityRecordElement.attrib['redundancyBefore'], reliabilityRecordElement.attrib['redundancyAfter'])
            reliabilityRecordList.append(reliabilityRecord)
        return reliabilityRecordList
