...
class Ui_Tsn(object):
    def setupUi(self, Tsn):
        ...
        Tsn.resize(833, 489)
        self.verticalLayoutWidget = QtWidgets.QWidget(Tsn)
        ...
        self.tableWidget_netargs.setRowCount(6)
    ...
    def retranslateUi(self, Tsn):
        ...
        item.setText(_translate("Tsn", "名称"))
        ...
        item.setText(_translate("Tsn", "IP"))
        item = self.tableWidget_netargs.verticalHeaderItem(5)
        item.setText(_translate("Tsn", "MAC"))
