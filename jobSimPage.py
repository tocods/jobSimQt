from util.jobSim import JobInfo, TaskInfo, CPUTaskInfo, GPUTaskInfo, FaultGenerator, ParseUtil, sysSim
...
class JobSimPage(QWidget):
    ...
    def refresh(self):
        ...
        self.table = QTableWidget(self.addJob)
        self.table.verticalHeader().setVisible(False)
        self.table.horizontalHeader().setVisible(False)
        self.table.setRowCount(5)
        self.table.setColumnCount(7)
        self.setColumnWidthAsProportion(self.table, [1, 1, 1, 1, 1, 1, 1], 1600)
