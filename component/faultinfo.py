...
class Ui_FaultInfo(object):
    def setupUi(self, FaultInfo):
        ...
        self.layoutWidget = QtWidgets.QWidget(parent=FaultInfo)
        self.layoutWidget.setGeometry(QtCore.QRect(20, 20, 881, 538))
        ...
        self.aim = QtWidgets.QComboBox(parent=self.layoutWidget)
        ...
        self.hardware = QtWidgets.QComboBox(parent=self.layoutWidget)
        self.hardware.setObjectName("hardware")
        self.hardware.addItem("CPU")
        self.hardware.addItem("内存")
        self.horizontalLayout_8.addWidget(self.hardware)
        ...
        self.type = QtWidgets.QComboBox(parent=self.layoutWidget)
        ...
        self.time1 = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.time2 = QtWidgets.QLineEdit(parent=self.layoutWidget)
        ...
        self.listWidget_2 = QtWidgets.QListWidget(parent=self.layoutWidget)
    ...
    def retranslateUi(self, FaultInfo):
        ...
        self.label_10.setText(_translate("FaultInfo", "故障硬件:"))
