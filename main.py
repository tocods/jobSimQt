...
class JobSimQt(QMainWindow):
    ...
    def readNetResult(self):
        ...
        self._ui.netanalysis.results.clear()
        self._ui.netanalysis.results.addTab(self.netResultTable, "结果")
        self._ui.netanalysis.results.addTab(self.delayChart, "端到端总延迟")
        self._ui.netanalysis.results.addTab(self.backChart, "最大缓冲区上界")
    ...
    def showDelay(self):
        ...
        self._ui.netanalysis.results.setCurrentIndex(1)
    ...
    def showBack(self):
        ...
        self._ui.netanalysis.results.setCurrentIndex(2)
